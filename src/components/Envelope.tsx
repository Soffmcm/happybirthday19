...
import stampPhoto from "@/assets/stamp-photo.jpg";
          ...
          >
            <AnimatePresence mode="wait" initial={false}>
              {!showBack ? (
                <motion.div
                  key="front"
                  className="envelope-shadow absolute inset-0 overflow-hidden"
                ...
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  transition={{ duration: 0.45, ease: "easeInOut" }}
                  onClick={stage === "back" ? handleEnvelopeClick : undefined}
                  whileHover={stage === "back" ? { scale: 1.03, y: -4 } : {}}
                  style={{
                    background: ENV_BODY,
                    borderRadius: "6px",
                    border: `1px solid ${ENV_EDGE}`,
                    boxShadow: "inset 0 0 30px oklch(0 0 0 / 0.06)",
                    cursor: stage === "back" ? "pointer" : "default",
                    transformStyle: "preserve-3d",
                    transformOrigin: "center center",
                  }}
                >
